...
let substituteSubst (newSubst: Map<string, Term>) (subst: list<string * Term>) = failwith "implemented in step 2"

let substituteTerms subst (terms: list<Term>) = failwith "implemented in step 2"

let rec unifyLists l1 l2 = failwith "implemented in steps 1 and 2"
...
let rec (|Number|_|) term = failwith "implemented in step 5"

let rec (|List|_|) term : option<list<Term>> = failwith "implemented in step 6"
...
let withFreshVariables (clause: Clause) : Clause = failwith "implemented in step 3"

let query (program: list<Clause>) (query: Term) = failwith "implemented in step 3"


let rec solve program subst goals = failwith "implemented in steps 4 and 6"

let run program query = failwith "implemented in step 6"
...
let rec makeList l : Term = failwith "implemented in step 6"
